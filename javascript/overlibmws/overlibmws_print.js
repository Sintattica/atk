/*
 overlibmws_print.js plug-in module - Copyright Foteos Macrides 2002-2006
   For support of the PRINT feature.
   Initial: April 25, 2005 - Last Revised: June 27, 2006
...
+OLlgfUtil(0,1,'','span',o3_printcolor,o3_printfont,o3_printsize))
+o3_printtext+(o3_printfontclass?'':OLlgfUtil(1,1,'','span'))+'</a></td>':'');
}
