...
## [11.8.0] - 2026-08-26
### Changed
- Deps: update smarty/smarty to v5.8.*


## [11.7.1] - 2026-04-21
### Changed
- Attribute: preserve selection order for multi-select fields and improve handling of selected/unselected values
...
## [11.3.5] - 2025-04-16
### Fixed
- Atk: page language now from user


## [11.3.4] - 2025-04-16
### Fixed
- Atk: added atk_menu param for username navbar link


## [11.3.3] - 2025-04-02
### Fixed
- Atk: fix warning in extended search
