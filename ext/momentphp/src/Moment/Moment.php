    ...
    public function getPeriod($period)
    {
        switch ($period) {
            ...
            case 'quarter':
                ...
                $momentPeriodVo = MomentHelper::getQuarterPeriod($quarter, $this->getYear(),
            ...
            default:
                throw new MomentException("Period \"{$period}\" is not supported yet (supported are \"week\" and \"month\").",
                    500);
        }
