...
class PhpCaptcha
{
    ...
    function DrawLines()
    {
        for ($i = 0; $i < $this->iNumLines; $i++) {
            ...
            // draw line
            imageline($this->oImage, rand(0, $this->iWidth), rand(0, $this->iHeight), rand(0, $this->iWidth),
    ...
    function DrawCharacters()
    {
        ...
        for ($i = 0; $i < strlen($this->sCode); $i++) {
            ...
            if ($this->bCharShadow) {
                ...
                imagefttext($this->oImage, $iFontSize, $iOffsetAngle, $iX + $iRandOffsetX, $iY + $iRandOffsetY,
                    $iShadowColour, $sCurrentFont, $this->sCode[$i], array());
            }
        }
    }
