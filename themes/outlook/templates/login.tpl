            ...
            <td width="100%">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#00309C">
                    <tr style="width: 100%">
                        ...
                        <td width="12" align="right" style="background-color: #D5E8F4; background-image: url({$themedir}images/right.gif);">&nbsp;</td>
                    </tr>
                </table>
                <div class="block" style="border:2px solid #00309C; background: #EEEEE0; padding: 2px;">
