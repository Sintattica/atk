<table class="shuttleTable">
    ...
    <tr>
        ...
        <td valign="center" align="center">
            ...
            <input type="button" value="&gt;&gt;" onClick="shuttle_moveall('{$leftname}', '{$rightname}', 'add', '{$name}');
                   {$htmlid}_onChange('selected');"><br/>
            <input type="button" value="&lt;&lt;" onClick="shuttle_moveall('{$rightname}', '{$leftname}', 'del', '{$name}');
