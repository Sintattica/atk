...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr><td bgcolor="#75736E" colspan="2" valign="top"><img src="{$themedir}images/blank.gif" height="1" width="1"></td></tr>
    <tr><td bgcolor="#FFFFFF" colspan="2" valign="top"><img src="{$themedir}images/blank.gif" height="1" width="1"></td></tr>
</table>
