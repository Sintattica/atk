...
//TODO: still to convert to jQuery
ATK.SmartSearchHandler = {
    ...
    addCriterium: function(url) {
        ...
        new Ajax.Updater('criteria', url, {method: 'post', parameters: params,
    ...
    registerCriteriumFieldListener: function(name, prefix, fieldEl, fieldUrl, valueEl, valueUrl, modeEl, modeUrl) {
        new Form.Element.EventObserver(name, function() {
            ...
            new Ajax.Updater(fieldEl, fieldUrl, {method: 'post',
                parameters: params, evalScripts: true, asynchronous: true
            });
            new Ajax.Updater(valueEl, valueUrl, {method: 'post',
                parameters: params, evalScripts: true, asynchronous: true
            });
            new Ajax.Updater(modeEl, modeUrl, {method: 'post',
                parameters: params, evalScripts: true, asynchronous: true
            });
        });
    }
