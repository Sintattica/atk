...
function initMouseDetection(a){var b=".smartmenus_mouse";if(mouseDetectionEnabled||a)mouseDetectionEnabled&&a&&($(document).off(b),mouseDetectionEnabled=!1);else{
// if we get two consecutive mousemoves within 2 pixels from each other and within 300ms, we assume a real mouse/cursor is present
// in practice, this seems like impossible to trick unintentianally with a real mouse and a pretty safe detection on touch devices (even with older browsers that do not support touch events)
var c=!0,d=null,e={mousemove:function(a){var b={x:a.pageX,y:a.pageY,timeStamp:(new Date).getTime()};if(d){var e=Math.abs(d.x-b.x),f=Math.abs(d.y-b.y);if((e>0||f>0)&&e<=2&&f<=2&&b.timeStamp-d.timeStamp<=300&&(mouse=!0,c)){var g=$(a.target).closest("a");g.is("a")&&$.each(menuTrees,function(){if($.contains(this.$root[0],g[0]))return this.itemEnter({currentTarget:g[0]}),!1}),c=!1}}d=b}};e[touchEvents?"touchstart":"pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut"]=function(a){isTouchEvent(a.originalEvent)&&(mouse=!1)},$(document).on(getEventsNS(e,b)),mouseDetectionEnabled=!0}}function isTouchEvent(a){return!/^(4|mouse)$/.test(a.pointerType)}
// returns a jQuery on() ready object
function getEventsNS(a,b){b||(b="");var c={};for(var d in a)c[d.split(" ").join(b+" ")+b]=a[d];return c}var menuTrees=[],mouse=!1,// optimize for touch by default - we will detect for mouse input
touchEvents="ontouchstart"in window,// we use this just to choose between toucn and pointer events, not for touch screen detection
mouseDetectionEnabled=!1,requestAnimationFrame=window.requestAnimationFrame||function(a){return setTimeout(a,1e3/60)},cancelAnimationFrame=window.cancelAnimationFrame||function(a){clearTimeout(a)},canAnimate=!!$.fn.animate;
// default settings
return $.SmartMenus=function(a,b){this.$root=$(a),this.opts=b,this.rootId="",// internal
...
this.disabled=!1,this.$disableOverlay=null,this.$touchScrollingSub=null,this.cssTransforms3d="perspective"in a.style||"webkitPerspective"in a.style,this.wasCollapsible=!1,this.init()},$.extend($.SmartMenus,{hideAll:function(){$.each(menuTrees,function(){this.menuHideAll()})},destroy:function(){for(;menuTrees.length;)menuTrees[0].destroy();initMouseDetection(!0)},prototype:{init:function(a){var b=this;if(!a){menuTrees.push(this),this.rootId=((new Date).getTime()+Math.random()+"").replace(/\D/g,""),this.accessIdPrefix="sm-"+this.rootId+"-",this.$root.hasClass("sm-rtl")&&(this.opts.rightToLeftSubMenus=!0);
// init root (main menu)
var c=".smartmenus";this.$root.data("smartmenus",this).attr("data-smartmenus-id",this.rootId).dataSM("level",1).on(getEventsNS({"mouseover focusin":$.proxy(this.rootOver,this),"mouseout focusout":$.proxy(this.rootOut,this),keydown:$.proxy(this.rootKeyDown,this)},c)).on(getEventsNS({mouseenter:$.proxy(this.itemEnter,this),mouseleave:$.proxy(this.itemLeave,this),mousedown:$.proxy(this.itemDown,this),focus:$.proxy(this.itemFocus,this),blur:$.proxy(this.itemBlur,this),click:$.proxy(this.itemClick,this)},c),"a"),
// hide menus on tap or click outside the root UL
c+=this.rootId,this.opts.hideOnClick&&$(document).on(getEventsNS({touchstart:$.proxy(this.docTouchStart,this),touchmove:$.proxy(this.docTouchMove,this),touchend:$.proxy(this.docTouchEnd,this),
// for Opera Mobile < 11.5, webOS browser, etc. we'll check click too
click:$.proxy(this.docClick,this)},c)),
// hide sub menus on resize
$(window).on(getEventsNS({"resize orientationchange":$.proxy(this.winResize,this)},c)),this.opts.subIndicators&&(this.$subArrow=$("<span/>").addClass("sub-arrow"),this.opts.subIndicatorsText&&this.$subArrow.html(this.opts.subIndicatorsText)),
...
return this.$touchScrollingSub?void(this.$touchScrollingSub=null):void((this.visibleSubMenus.length&&!$.contains(this.$root[0],a.target)||$(a.target).closest("a").length)&&this.menuHideAll())},docTouchEnd:function(a){if(this.lastTouch){if(this.visibleSubMenus.length&&(void 0===this.lastTouch.x2||this.lastTouch.x1==this.lastTouch.x2)&&(void 0===this.lastTouch.y2||this.lastTouch.y1==this.lastTouch.y2)&&(!this.lastTouch.target||!$.contains(this.$root[0],this.lastTouch.target))){this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=0);
// hide with a delay to prevent triggering accidental unwanted click on some page element
var b=this;this.hideTimeout=setTimeout(function(){b.menuHideAll()},350)}this.lastTouch=null}},docTouchMove:function(a){if(this.lastTouch){var b=a.originalEvent.touches[0];this.lastTouch.x2=b.pageX,this.lastTouch.y2=b.pageY}},docTouchStart:function(a){var b=a.originalEvent.touches[0];this.lastTouch={x1:b.pageX,y1:b.pageY,target:b.target}},enable:function(){this.disabled&&(this.$disableOverlay&&(this.$disableOverlay.remove(),this.$disableOverlay=null),this.disabled=!1)},getClosestMenu:function(a){for(var b=$(a).closest("ul");b.dataSM("in-mega");)b=b.parent().closest("ul");return b[0]||null},getHeight:function(a){return this.getOffset(a,!0)},
// returns precise width/height float values
getOffset:function(a,b){var c;"none"==a.css("display")&&(c={position:a[0].style.position,visibility:a[0].style.visibility},a.css({position:"absolute",visibility:"hidden"}).show());var d=a[0].getBoundingClientRect&&a[0].getBoundingClientRect(),e=d&&(b?d.height||d.bottom-d.top:d.width||d.right-d.left);return e||0===e||(e=b?a[0].offsetHeight:a[0].offsetWidth),c&&a.hide().css(c),e},getStartZIndex:function(a){var b=parseInt(this[a?"$root":"$firstSub"].css("z-index"));return!a&&isNaN(b)&&(b=parseInt(this.$root.css("z-index"))),isNaN(b)?1:b},getTouchPoint:function(a){return a.touches&&a.touches[0]||a.changedTouches&&a.changedTouches[0]||a},getViewport:function(a){var b=a?"Height":"Width",c=document.documentElement["client"+b],d=window["inner"+b];return d&&(c=Math.min(c,d)),c},getViewportHeight:function(){return this.getViewport(!0)},getViewportWidth:function(){return this.getViewport()},getWidth:function(a){return this.getOffset(a)},handleEvents:function(){return!this.disabled&&this.isCSSOn()},handleItemEvents:function(a){return this.handleEvents()&&!this.isLinkInMegaMenu(a)},isCollapsible:function(){return"static"==this.$firstSub.css("position")},isCSSOn:function(){return"inline"!=this.$firstLink.css("display")},isFixed:function(){var a="fixed"==this.$root.css("position");return a||this.$root.parentsUntil("body").each(function(){if("fixed"==$(this).css("position"))return a=!0,!1}),a},isLinkInMegaMenu:function(a){return $(this.getClosestMenu(a[0])).hasClass("mega-menu")},isTouchMode:function(){return!mouse||this.opts.noMouseOver||this.isCollapsible()},itemActivate:function(a,b){var c=a.closest("ul"),d=c.dataSM("level");
// if for some reason the parent item is not activated (e.g. this is an API call to activate the item), activate all parent items first
if(d>1&&(!this.activatedItems[d-2]||this.activatedItems[d-2][0]!=c.dataSM("parent-a")[0])){var e=this;$(c.parentsUntil("[data-smartmenus-id]","ul").get().reverse()).add(c).each(function(){e.itemActivate($(this).dataSM("parent-a"))})}if(
// hide any visible deeper level sub menus
this.isCollapsible()&&!b||this.menuHideSubMenus(this.activatedItems[d-1]&&this.activatedItems[d-1][0]==a[0]?d:d-1),
// save new active item for this level
this.activatedItems[d-1]=a,this.$root.triggerHandler("activate.smapi",a[0])!==!1){
// show the sub menu if this item has one
var f=a.dataSM("sub");f&&(this.isTouchMode()||!this.opts.showOnClick||this.clickActivated)&&this.menuShow(f)}},itemBlur:function(a){var b=$(a.currentTarget);this.handleItemEvents(b)&&this.$root.triggerHandler("blur.smapi",b[0])},itemClick:function(a){var b=$(a.currentTarget);if(this.handleItemEvents(b)){if(this.$touchScrollingSub&&this.$touchScrollingSub[0]==b.closest("ul")[0])return this.$touchScrollingSub=null,a.stopPropagation(),!1;if(this.$root.triggerHandler("click.smapi",b[0])===!1)return!1;var c=$(a.target).is(".sub-arrow"),d=b.dataSM("sub"),e=!!d&&2==d.dataSM("level"),f=this.isCollapsible(),g=/toggle$/.test(this.opts.collapsibleBehavior),h=/link$/.test(this.opts.collapsibleBehavior),i=/^accordion/.test(this.opts.collapsibleBehavior);
// if the sub is hidden, try to show it
if(d&&!d.is(":visible")){if((!h||!f||c)&&(this.opts.showOnClick&&e&&(this.clickActivated=!0),
// try to activate the item and show the sub
this.itemActivate(b,i),d.is(":visible")))return this.focusActivated=!0,!1}else if(f&&(g||c))return this.itemActivate(b,i),this.menuHide(d),g&&(this.focusActivated=!1),!1;return!(this.opts.showOnClick&&e||b.hasClass("disabled")||this.$root.triggerHandler("select.smapi",b[0])===!1)&&void 0}},itemDown:function(a){var b=$(a.currentTarget);this.handleItemEvents(b)&&b.dataSM("mousedown",!0)},itemEnter:function(a){var b=$(a.currentTarget);if(this.handleItemEvents(b)){if(!this.isTouchMode()){this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=0);var c=this;this.showTimeout=setTimeout(function(){c.itemActivate(b)},this.opts.showOnClick&&1==b.closest("ul").dataSM("level")?1:this.opts.showTimeout)}this.$root.triggerHandler("mouseenter.smapi",b[0])}},itemFocus:function(a){var b=$(a.currentTarget);this.handleItemEvents(b)&&(
// fix (the mousedown check): in some browsers a tap/click produces consecutive focus + click events so we don't need to activate the item on focus
!this.focusActivated||this.isTouchMode()&&b.dataSM("mousedown")||this.activatedItems.length&&this.activatedItems[this.activatedItems.length-1][0]==b[0]||this.itemActivate(b,!0),this.$root.triggerHandler("focus.smapi",b[0]))},itemLeave:function(a){var b=$(a.currentTarget);this.handleItemEvents(b)&&(this.isTouchMode()||(b[0].blur(),this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=0)),b.removeDataSM("mousedown"),this.$root.triggerHandler("mouseleave.smapi",b[0]))},menuHide:function(a){if(this.$root.triggerHandler("beforehide.smapi",a[0])!==!1&&(canAnimate&&a.stop(!0,!0),"none"!=a.css("display"))){var b=function(){
// unset z-index
a.css("z-index","")};
// if sub is collapsible (mobile view)
this.isCollapsible()?canAnimate&&this.opts.collapsibleHideFunction?this.opts.collapsibleHideFunction.call(this,a,b):a.hide(this.opts.collapsibleHideDuration,b):canAnimate&&this.opts.hideFunction?this.opts.hideFunction.call(this,a,b):a.hide(this.opts.hideDuration,b),
// deactivate scrolling if it is activated for this sub
a.dataSM("scroll")&&(this.menuScrollStop(a),a.css({"touch-action":"","-ms-touch-action":"","-webkit-transform":"",transform:""}).off(".smartmenus_scroll").removeDataSM("scroll").dataSM("scroll-arrows").hide()),
// unhighlight parent item + accessibility
a.dataSM("parent-a").removeClass("highlighted").attr("aria-expanded","false"),a.attr({"aria-expanded":"false","aria-hidden":"true"});var c=a.dataSM("level");this.activatedItems.splice(c-1,1),this.visibleSubMenus.splice($.inArray(a,this.visibleSubMenus),1),this.$root.triggerHandler("hide.smapi",a[0])}},menuHideAll:function(){this.showTimeout&&(clearTimeout(this.showTimeout),this.showTimeout=0);for(var a=this.opts.isPopup?1:0,b=this.visibleSubMenus.length-1;b>=a;b--)this.menuHide(this.visibleSubMenus[b]);
// hide root if it's popup
this.opts.isPopup&&(canAnimate&&this.$root.stop(!0,!0),this.$root.is(":visible")&&(canAnimate&&this.opts.hideFunction?this.opts.hideFunction.call(this,this.$root):this.$root.hide(this.opts.hideDuration))),this.activatedItems=[],this.visibleSubMenus=[],this.clickActivated=!1,this.focusActivated=!1,
// reset z-index increment
this.zIndexInc=0,this.$root.triggerHandler("hideAll.smapi")},menuHideSubMenus:function(a){for(var b=this.activatedItems.length-1;b>=a;b--){var c=this.activatedItems[b].dataSM("sub");c&&this.menuHide(c)}},menuInit:function(a){if(!a.dataSM("in-mega")){
...
function(a){"function"==typeof define&&define.amd?
// AMD
define(["jquery","smartmenus"],a):"object"==typeof module&&"object"==typeof module.exports?
// CommonJS
module.exports=a(require("jquery")):
// Global jQuery
a(jQuery)}(function(a){
...
subMenusSubOffsetX:2,subMenusSubOffsetY:-6,subIndicators:!1,collapsibleShowFunction:null,collapsibleHideFunction:null,rightToLeftSubMenus:e.hasClass("navbar-right"),bottomToTopSubMenus:e.closest(".navbar").hasClass("navbar-fixed-bottom")}).on({
...
f.isCollapsible=function(){return!/^(left|right)$/.test(this.$firstLink.parent().css("float"))&&"block"==this.$root.css("display")},
...
e.is("[data-sm-skip-collapsible-behavior]")&&(f.opts.collapsibleBehavior="toggle");
// onresize detect when the navbar becomes collapsible and add it the "sm-collapsible" class
var g;d(),a(window).on("resize.smartmenus"+f.rootId,d)}}),
...
jQuery(function(){setTimeout(function(){jQuery(window).trigger("resize")},10)});