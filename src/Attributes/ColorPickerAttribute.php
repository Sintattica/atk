...
class ColorPickerAttribute extends Attribute
{
    ...
    function edit($record = "", $fieldprefix = "", $mode = "")
    {
        ...
        $url = Tools::atkPopup('atk/popups/colorpicker.php',
    ...
    function validate(&$record, $mode)
    {
        ...
        if (!$this->check_color($color)) {
            Tools::triggerError($record, $this, 'error_invalid_color');
        }
    }
    ...
    function check_color()
    {
        ...
        if ($type == "hex") {
            ...
            Tools::atkerror("Error in function check_color(): Invalid argument for color type.");
            return false;
        }
    }
    ...
    {
        if ($numargs < 1) {
            Tools::atkerror("Error in function check_color(): No arguments passed to function.");
            return false;
        }

        if ($numargs > 2) {
            Tools::atkerror("Error in function check_color(): Too many arguments passed to function.");
            return false;
        }
