 ...
 *
 */
class MlWrapper extends Attribute
{
    ...
    function addToEditArray($mode, &$arr, &$defaults, &$error, $fieldprefix)
    {
        ...
        foreach (array_keys($this->m_childList) as $lng) {
            ...
            if ($lng == $defaultlng) {
                ...
                // other languages
                $attr->setLabel($this->label() . " (" . Tools::atktext('language_' . strtolower($lng)) . ")");
    ...
    {
        Tools::atkdebug("mlwrap validate");
    }
    ...
    {
        Tools::atkdebug("mlwrap dbfieldtype");
    }
    ...
    {
        Tools::atkdebug("mlwrap dbfieldsize");
    }
