 ...
 * $Id$
 */
class Cache_zp_output extends Cache
{
    ...
    public function add($key, $data, $lifetime = false)
    {
        ...
        if ($lifetime !== false) {
            Tools::atkwarning("Lifetime setting is not supported in this type of cache :" . $this->getType() . ". Instead default lifetime is used");
        }
