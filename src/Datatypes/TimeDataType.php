...
class TimeDataType extends DataType
{
    ...
    public function __construct($time = 0)
    {
        ...
        if (is_array($time)) {
            ...
            if (is_numeric($time)) {
                ...
                Tools::atkerror("Unknown time format! Called with: " .
                    "new atkTime($time)");
            }
        }
    }
     ...
     *
     * example: Time::create(3677)->getHours() returns 1
     * example: Time::create(3680)->getHours(true) returns "01"
     *
     * @param bool $leadingzero Wether or not to use a leading zero
     *                          when applicable.
     ...
     *
     * example: Time::create(126)->getMinutes() returns 2
     * example: Time::create(126)->getMinutes(true) returns "02"
     *
     * @param bool $leadingzero Wether or not to use a leading zero
     *                          when applicable.
     ...
     *
     * example: Time::create(45)->getSeconds() returns 45
     * example: Time::create(5)->getSeconds(true) returns "05"
     *
     * @param bool $leadingzero Wether or not to use a leading zero
     *                          when applicable.
     ...
     *
     * example: Time::create(3666)->getDescription(
    ...
    public function getFormatted($format = '')
    {
        ...
        Tools::atkdebug("formatting time: {$this->m_time} with format $format");
     ...
     *
     * example: Time::create(3600)->getDiff(new atkTime(600)) will
