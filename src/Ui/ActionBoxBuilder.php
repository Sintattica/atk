...
class ActionBoxBuilder
{
    ...
    public function __construct(PageBuilder $pageBuilder)
    {
        ...
        $this->formStart('<form id="entryform" name="entryform" enctype="multipart/form-data" action="'.Config::getGlobal('dispatcher').'" method="post" onsubmit="return ATK.globalSubmit(this,true)">');
    }
