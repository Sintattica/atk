...
class auth_saml extends auth_interface
{
    ...
    {
        $simplesamlPath = Config::getGlobal("auth_saml_simplesaml_path");
        require_once(Config::getGlobal('atkroot') . $simplesamlPath . 'lib/_autoload.php');
        $as = new SimpleSAML_Auth_Simple(Config::getGlobal('auth_saml_authsource', 'default-sp'));
        ...
        self::$_samlUser = array(
            "name" => $attributes[Config::getGlobal("auth_userid_field", "uid")][0],
