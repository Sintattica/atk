 ...
 * @subpackage utils
 */
class MLSelector extends Selector
{
     ...
     */
    protected function _applyMultiLanguageConditionsToQuery(Query $query)
    {
        $mlSplitter = Tools::atkinstance("atk.utils.atkmlsplitter");
