 ...
 * @subpackage utils
 */
class CompatSelector extends Selector
{
    ...
    {
        if ($this->m_rows === null) {
            Tools::atkwarning("Using deprecated selectDb override for node " . $this->_getNode()->atkNodeType());
    ...
    public function getRowCount()
    {
        if ($this->m_rowCount === null) {
            Tools::atkwarning("Using deprecated countDb override for node " . $this->_getNode()->atkNodeType());
            $selector = $this->_buildSelector();
