<?php
  ...
  class PhpCaptcha 
  {
    ...
    {
      // get parameters
      $this->aFonts = atkConfig::get("captcha", "captcha_fonts");
      $this->SetNumChars(atkConfig::get("captcha", "captcha_num_chars"));
      $this->SetNumLines(atkConfig::get("captcha", "captcha_num_lines"));
      $this->DisplayShadow(atkConfig::get("captcha", "captcha_display_shadow"));
      $this->SetOwnerText(atkConfig::get("captcha", "captcha_owner_text"));
      $this->SetCharSet(atkConfig::get("captcha", "captcha_char_set"));
      $this->SetBackgroundImage(atkConfig::get("captcha", "captcha_background_image"));
      $this->SetMinFontSize(atkConfig::get("captcha", "captcha_min_font_size"));
      $this->SetMaxFontSize(atkConfig::get("captcha", "captcha_max_font_size"));
      $this->UseColour(atkConfig::get("captcha", "captcha_use_colour"));
      $this->SetFileType(atkConfig::get("captcha", "captcha_file_type"));   
      $this->SetWidth(atkConfig::get("captcha", "captcha_width"));
      $this->SetHeight(atkConfig::get("captcha", "captcha_height"));
